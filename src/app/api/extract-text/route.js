// // src/app/api/extract-document/route.js
// import { NextRequest, NextResponse } from 'next/server';
// import { promisify } from 'util';

// // Dynamic imports to avoid build-time issues
// let pdf, mammoth, XLSX, parseString;
...
//       case 'pdf':
//         if (!pdf) {
//           return NextResponse.json({ error: 'PDF parsing not available' }, { status: 500 });
//         }
//         try {
//           const pdfData = await pdf(buffer);
//           extractedData.text = pdfData.text;
//           extractedData.pages = pdfData.numpages;
//           extractedData.metadata = pdfData.info;
//         } catch (error) {
